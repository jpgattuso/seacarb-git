...
## AD-friendly re-implementation of the seacarb constant set
## (k1k2="l", ks="d", kf="dg", b="u74", pHscale="T").  Plain arithmetic only:
## no as.numeric(), no attr(), no ifelse() on values, so duals flow through.
Kall <- function(T, S) {
