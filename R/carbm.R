...
#
carbm<-
function(flag, var1, var2, badd=0, S=35, T=25, Patm=1, P=0, Pt=0, Sit=0, k1k2='x', kf='x', ks="d", pHscale="T", b="l10"){
RES <- data.frame()
...
df <- data.frame(flag, var1, var2, S, T, Patm, P, Pt, Sit, pHscale, k1k2, kf, ks, badd, b)
